package mobi.audiogear.staticfrequency.lib;
...
/**
 * Obscures SharedPreferences <p> Warning, this gives a false sense of security. If
 * an attacker has enough access to acquire your password store, then he almost
 * certainly has enough access to acquire your source binary and figure out
 * your encryption key. However, it will prevent casual investigators from
 * acquiring passwords, and thereby may prevent undesired negative
 * publicity. <p> Code from: https://tinyurl.com/so-obs-sharedprefs
 */
