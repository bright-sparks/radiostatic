package mobi.audiogear.staticfrequency;

import mobi.audiogear.staticfrequency.lib.ApplicationPattern;
import mobi.audiogear.staticfrequency.lib.HTTPManager;
...
/**
 * The Application class for StaticFrequency. Provides a static reference to the
 * {@link mobi.audiogear.staticfrequency.lib.HTTPManager},
...
public class Application extends ApplicationPattern {
  ...
  public void onCreate() {
    ...
    char[] secret = {
      '7', '7', 'd', '2', 'b', 'a', '7', 'f', '7', '8', '4', 'f', 'a', '9', 'e', '6', 'a', '0', '6',
      'd', '6', 'd', '9', '3', '9', 'a', '1', '7', '5', 'a', 'a', '9'
    };
