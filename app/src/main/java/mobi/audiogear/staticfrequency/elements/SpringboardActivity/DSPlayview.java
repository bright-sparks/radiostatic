...
/**
 * The custom element class for DSPlayview which extends
 ...
 * and its parent element is {@link mobi.audiogear.staticfrequency.elements.SpringboardActivity.DSPlay}.
 ...
 * wideViewportEnabled.
 */
public class DSPlayview extends WebView implements DropsourceVaried {
  /**
  ...
  /**
   * {@link #DSPlayview(Context, AttributeSet)}
   */
  ...
  /**
   * {@link #DSPlayview(Context, AttributeSet, int)}
   */
  public DSPlayview(Context context, AttributeSet attrs) {
   ...
   *
   */
  public DSPlayview(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);

    this.variant = "Default";

    this.setId(R.id.playview);
