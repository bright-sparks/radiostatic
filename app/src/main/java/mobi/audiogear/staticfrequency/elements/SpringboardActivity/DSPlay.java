 ...
 * enabled; and 1 children: {@link mobi.audiogear.staticfrequency.elements.SpringboardActivity.DSPlayview}.
 */
public class DSPlay extends PercentRelativeLayout implements DropsourceVaried {
  ...
  /**
   * This element's child playview.
   */
  public DSPlayview _getPlayview() {
    return (DSPlayview) this.findViewById(R.id.playview);
  }
}