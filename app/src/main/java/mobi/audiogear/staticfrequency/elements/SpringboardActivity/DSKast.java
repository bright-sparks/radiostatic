 ...
 * enabled; and 1 children: {@link mobi.audiogear.staticfrequency.elements.SpringboardActivity.DSKastview}.
 */
public class DSKast extends PercentRelativeLayout implements DropsourceVaried {
  /**
  ...
  /**
   * This element's child kastview.
   */
  public DSKastview _getKastview() {
    return (DSKastview) this.findViewById(R.id.kastview);
  }
}