...
/**
 * The custom element class for DSStudioview which extends
 ...
 * and its parent element is {@link mobi.audiogear.staticfrequency.elements.SpringboardActivity.DSStudio}.
 ...
 * wideViewportEnabled.
 */
public class DSStudioview extends WebView implements DropsourceVaried {
  /**
  ...
  /**
   * {@link #DSStudioview(Context, AttributeSet)}
   */
  public DSStudioview(Context context) {
    this(context, null);
  }

  /**
   * {@link #DSStudioview(Context, AttributeSet, int)}
   */
  public DSStudioview(Context context, AttributeSet attrs) {
   ...
   *
   */
  public DSStudioview(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);

    this.variant = "Default";

    this.setId(R.id.studioview);
    ...
    this.loadUrl("http://xprs.imcreator.com/free/martinmyburgh/radiolove");
  }
  ...
  /**
   * Retrieves the parent {@link DSStudio} of this element.
   *
   * @return the parent {@link DSStudio}
   */
  public DSStudio _getParent() {
    return (DSStudio) getParent();
  }
}